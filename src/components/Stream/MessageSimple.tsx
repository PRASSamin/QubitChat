...
import { MessageContextValue, useMessageContext } from "stream-chat-expo";
import { MessagesContextValue, useMessagesContext } from "stream-chat-expo";
import { useTheme } from "stream-chat-expo";

import { triggerHaptic } from "stream-chat-expo/src/optionalDependencies";
import { useMessageData } from "stream-chat-react-native-core/src/components/Message/hooks/useMessageData";
...
>(
  ...
  const lastMessageInMessageListStyles = [
    ...
    () => (
      <GestureDetector gesture={swipeGesture}>
        ...
        >
          ...
          <Animated.View style={messageBubbleAnimatedStyle}>
            {renderMessageBubble}
          </Animated.View>
        </View>
      </GestureDetector>
        ...
        >
          <View
            style={[
              {
                paddingBottom:
                  hasReactions && reactionListPosition === "top"
                    ? reactionPosition
                    : 2,
              },
              headerWrapper,
