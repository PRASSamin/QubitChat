...
>(
  ...
  const { hasThreadReplies, isMessageErrorType, isMessageReceivedOrErrorType } =
    useMessageData({});
      ...
      <View onLayout={onLayout} style={wrapper}>
        ...
        <View
          style={[
            ...
            {
              backgroundColor,
              borderColor: isMessageReceivedOrErrorType
                ? grey_whisper
                : backgroundColor,
              ...getBorderRadius(),
          ...
          {messageContentOrder.map(
            (messageContentType, messageContentOrderIndex) => {
              switch (messageContentType) {
                ...
                case "gallery":
                  return (
                    <Gallery key={`gallery_${messageContentOrderIndex}`} />
                  );
                case "poll": {
...
>(
  ...
  const isEditedMessageOpenEqual =
    prevIsEditedMessageOpen === nextIsEditedMessageOpen;
